...
func InitArticleService(r repository.Repository, l slog.Logger) *ArticleService {
...
func (s *ArticleService) PostArticle(article domain.Article) (domain.Article, error) {
	article.ID = uuid.New()
...
func (s *ArticleService) GetArticlesList(page, limit int32) ([]domain.Article, int32, error) {
...
func (s *ArticleService) PostComment(comment domain.Comment) (domain.Comment, error) {
	comment.ID = uuid.New()
...
func (s *ArticleService) GetArticle(id uuid.UUID, commentPage, pageLimit int32) (domain.Article, []domain.Comment, error) {
